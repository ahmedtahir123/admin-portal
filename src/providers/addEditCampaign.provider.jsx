...
import AddEditCampaignContainer from "../containers/AddEditCampaign";
...
const AddEditCampaignProvider = withRouter(connect(mapStateToProps, mapDispatchToProps)(AddEditCampaignContainer));

export default AddEditCampaignProvider;
