...
import "./AddEditBaitussalamWeb&AppOnlineCharityManagement.scss";
import "../../styles/_helpers.scss";

const AddEditBaitussalamWebAndAppOnlineCharityManagementContainer = ({
  selected,
  loading,
  getUserById,
  updateUser,
...
AddEditBaitussalamWebAndAppOnlineCharityManagementContainer.propTypes = {
...
export default AddEditBaitussalamWebAndAppOnlineCharityManagementContainer;
