...
import { Form, Input, Button, Row, Col, Radio, Spin, Divider, Popconfirm, Select, DatePicker } from "antd";
...
import "./AddEditBaitussalamWeb&AppBayanatManagement.scss";
import "../../styles/_helpers.scss";
import GalleryGrid from "../GalleryGrid";

const AddEditBaitussalamWebAndAppBayanatManagementContainer = ({
  selected,
  loading,
  getUserById,
  updateUser,
  ...
  return (
    <>
      ...
      <PageTitle title={isEditView ? "Edit Bayanat" : "Add Bayanat"} />
      <Form
        className="AddUser"
        form={form}
        layout="vertical"
      ...
      >
        <Row className="fields-row" gutter={20} type="flex">
          <Col span={8} xs={24} sm={12} lg={12}>
            <Form.Item label="Bayanat Category" name="Bayanat Category" rules={[{ required: true }]}>
              <Select placeholder="Bayanat Category">
                {_map([], city => (
            ...
            >
              <DatePicker showTime format={DATE_FORMAT_TIME} />
            </Form.Item>
          </Col>
          <Col span={8} xs={24} sm={12} lg={12}>
            <Form.Item label="">
...
AddEditBaitussalamWebAndAppBayanatManagementContainer.propTypes = {
...
export default AddEditBaitussalamWebAndAppBayanatManagementContainer;
