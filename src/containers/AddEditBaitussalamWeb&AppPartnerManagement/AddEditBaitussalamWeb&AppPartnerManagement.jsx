...
import "./AddEditBaitussalamWeb&AppPartnerManagement.scss";
import "../../styles/_helpers.scss";

const AddEditBaitussalamWebAndAppPartnerManagementContainer = ({
  selected,
  loading,
  getUserById,
  updateUser,
...
AddEditBaitussalamWebAndAppPartnerManagementContainer.propTypes = {
...
export default AddEditBaitussalamWebAndAppPartnerManagementContainer;
