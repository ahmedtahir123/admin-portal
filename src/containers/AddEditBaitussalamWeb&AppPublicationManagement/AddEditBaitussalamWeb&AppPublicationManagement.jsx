...
import "./AddEditBaitussalamWeb&AppPublicationManagement.scss";
import "../../styles/_helpers.scss";
import GalleryGrid from "../GalleryGrid";

const AddEditBaitussalamWebAndAppPublicationManagementContainer = ({
  selected,
  loading,
  getUserById,
  updateUser,
  ...
  return (
    <>
      ...
      <PageTitle title={isEditView ? "Edit Publication" : "Add Publication"} />
      <Form
        className="AddUser"
        form={form}
        layout="vertical"
...
AddEditBaitussalamWebAndAppPublicationManagementContainer.propTypes = {
...
export default AddEditBaitussalamWebAndAppPublicationManagementContainer;
