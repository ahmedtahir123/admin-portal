...
const AddEditBaitussalamWebAndAppBayanatCategoryManagementContainer = ({
  ...
  return (
    <>
      ...
      <PageTitle title={isEditView ? "Edit Bayanat Category" : "Add Bayanat Category"} />
      <Form
        className="AddUser"
        form={form}
        layout="vertical"
      ...
      >
        <Row className="fields-row" gutter={20} type="flex">
          <Col span={8} xs={24} sm={12} lg={12}>
            ...
            <Form.Item label="Image Width" name="Image Width" rules={[{ required: true }]}>
              <Select placeholder="Image Width">
                {_map([], city => (
                  <Option key={city.code} value={city.code}>
                    {city.name}
                  </Option>
...
AddEditBaitussalamWebAndAppBayanatCategoryManagementContainer.propTypes = {
...
export default AddEditBaitussalamWebAndAppBayanatCategoryManagementContainer;
