...
import { Form, Input, Button, Row, Col, Radio, Spin, Divider, Popconfirm, InputNumber, DatePicker } from "antd";
...
import "./AddEditBaitussalamWeb&AppGuidesManagement.scss";
import "../../styles/_helpers.scss";
import GalleryGrid from "../GalleryGrid";

const AddEditBaitussalamWebAndAppGuidesManagementContainer = ({
  selected,
  loading,
  getUserById,
  updateUser,
  ...
  return (
    <>
      ...
      <PageTitle title={isEditView ? "Edit Guides" : "Add Guides"} />
      <Form
        className="AddUser"
        form={form}
        layout="vertical"
...
AddEditBaitussalamWebAndAppGuidesManagementContainer.propTypes = {
...
export default AddEditBaitussalamWebAndAppGuidesManagementContainer;
