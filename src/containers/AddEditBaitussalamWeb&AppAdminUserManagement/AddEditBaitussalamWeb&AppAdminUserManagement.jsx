...
import "./AddEditBaitussalamWeb&AppAdminUserManagement.scss";
import "../../styles/_helpers.scss";

const AddEditBaitussalamWebAndAppAdminUserManagementContainer = ({
  selected,
  loading,
  getUserById,
  updateUser,
...
AddEditBaitussalamWebAndAppAdminUserManagementContainer.propTypes = {
...
export default AddEditBaitussalamWebAndAppAdminUserManagementContainer;
