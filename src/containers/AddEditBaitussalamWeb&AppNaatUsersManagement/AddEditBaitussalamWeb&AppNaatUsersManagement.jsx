...
import "./AddEditBaitussalamWeb&AppNaatUsersManagement.scss";
import "../../styles/_helpers.scss";

const AddEditBaitussalamWebAndAppNaatUsersManagementContainer = ({
  selected,
  loading,
  getUserById,
  updateUser,
...
AddEditBaitussalamWebAndAppNaatUsersManagementContainer.propTypes = {
...
export default AddEditBaitussalamWebAndAppNaatUsersManagementContainer;
