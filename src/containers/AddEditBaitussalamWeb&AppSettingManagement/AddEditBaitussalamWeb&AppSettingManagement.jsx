...
import "./AddEditBaitussalamWeb&AppSettingManagement.scss";
import "../../styles/_helpers.scss";

const AddEditBaitussalamWebAndAppVideosManagementContainer = ({
  selected,
  loading,
  getUserById,
  updateUser,
...
AddEditBaitussalamWebAndAppVideosManagementContainer.propTypes = {
...
export default AddEditBaitussalamWebAndAppVideosManagementContainer;
