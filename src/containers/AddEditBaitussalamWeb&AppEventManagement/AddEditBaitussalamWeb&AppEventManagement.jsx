...
import "./AddEditBaitussalamWeb&AppEventManagement.scss";
import "../../styles/_helpers.scss";

const AddEditBaitussalamWebAndAppEventManagementContainer = ({
  selected,
  loading,
  getUserById,
  updateUser,
...
AddEditBaitussalamWebAndAppEventManagementContainer.propTypes = {
...
export default AddEditBaitussalamWebAndAppEventManagementContainer;
