...
import "./AddEditBaitussalamWeb&AppVideosManagement.scss";
import "../../styles/_helpers.scss";
import GalleryGrid from "../GalleryGrid";

const AddEditBaitussalamWebAndAppSettingManagementContainer = ({
  selected,
  loading,
  getUserById,
  updateUser,
...
AddEditBaitussalamWebAndAppSettingManagementContainer.propTypes = {
...
export default AddEditBaitussalamWebAndAppSettingManagementContainer;
