...
import "./AddEditBaitussalamWeb&AppGalleryManagement.scss";
import "../../styles/_helpers.scss";
import GalleryGrid from "../GalleryGrid";

const AddEditBaitussalamWebAndAppGalleryManagementContainer = ({
  selected,
  loading,
  getUserById,
  updateUser,
  ...
  return (
    <>
      ...
      <PageTitle title={isEditView ? "Edit Galleries" : "Add Galleries"} />
      <Form
        className="AddUser"
        form={form}
        layout="vertical"
      ...
      >
        <Row className="fields-row" gutter={20} type="flex">
          <Col span={8} xs={24} sm={12} lg={12}>
            <Form.Item label="Album" name="Album" rules={[{ required: true }]}>
              <Select placeholder="Album">
                {_map([], city => (
...
AddEditBaitussalamWebAndAppGalleryManagementContainer.propTypes = {
...
export default AddEditBaitussalamWebAndAppGalleryManagementContainer;
