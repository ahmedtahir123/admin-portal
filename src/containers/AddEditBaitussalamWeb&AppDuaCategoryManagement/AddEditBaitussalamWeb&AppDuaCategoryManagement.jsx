import { Button, Col, Divider, Form, Input, Popconfirm, Radio, Row, Spin } from "antd";
...
import "./AddEditBaitussalamWeb&AppDuaCategoryManagement.scss";

const AddEditBaitussalamWebAndAppDuaCategoryManagementContainer = ({
  selected,
  loading,
  getUserById,
  updateUser,
  ...
  return (
    <>
      ...
      <PageTitle title={isEditView ? "Edit Dua Categories" : "Add Dua Categories"} />
      <Form
        className="AddUser"
        form={form}
        layout="vertical"
...
AddEditBaitussalamWebAndAppDuaCategoryManagementContainer.propTypes = {
...
export default AddEditBaitussalamWebAndAppDuaCategoryManagementContainer;
