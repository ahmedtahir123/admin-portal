...
import "./AddEditBaitussalamWeb&AppFeaturedBannersManagement.scss";
import "../../styles/_helpers.scss";
import GalleryGrid from "../GalleryGrid";

const AddEditBaitussalamWebAndAppFeaturedBannersManagementContainer = ({
  selected,
  loading,
  getUserById,
  updateUser,
...
AddEditBaitussalamWebAndAppFeaturedBannersManagementContainer.propTypes = {
...
export default AddEditBaitussalamWebAndAppFeaturedBannersManagementContainer;
