...
import "./AddEditBaitussalamWeb&AppSaibanManagement.scss";
import "../../styles/_helpers.scss";

const AddEditBaitussalamWebAndAppSaibanManagementContainer = ({
  selected,
  loading,
  getUserById,
  updateUser,
...
AddEditBaitussalamWebAndAppSaibanManagementContainer.propTypes = {
...
export default AddEditBaitussalamWebAndAppSaibanManagementContainer;
