...
import "./AddEditBaitussalamWeb&AppVolunteerManagement.scss";
import "../../styles/_helpers.scss";

const AddEditBaitussalamWebAndAppVolunteerManagementContainer = ({
  selected,
  loading,
  getUserById,
  updateUser,
...
AddEditBaitussalamWebAndAppVolunteerManagementContainer.propTypes = {
...
export default AddEditBaitussalamWebAndAppVolunteerManagementContainer;
