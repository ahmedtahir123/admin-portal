...
import "./AddEditBaitussalamWeb&AppCustomerManagement.scss";
import "../../styles/_helpers.scss";

const AddEditBaitussalamWebAndAppCustomerManagementConatiner = ({
  selected,
  loading,
  getUserById,
  updateUser,
...
AddEditBaitussalamWebAndAppCustomerManagementConatiner.propTypes = {
...
export default AddEditBaitussalamWebAndAppCustomerManagementConatiner;
