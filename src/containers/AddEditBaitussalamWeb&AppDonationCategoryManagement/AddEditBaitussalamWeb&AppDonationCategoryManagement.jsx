...
import { Form, Input, Button, Row, Col, Radio, Spin, Divider, Popconfirm, Select, Switch, Upload } from "antd";
...
import "./AddEditBaitussalamWeb&AppDonationCategoryManagement.scss";
import "../../styles/_helpers.scss";

const AddEditBaitussalamWebAndAppDonationCategoryManagementContainer = ({
  selected,
  loading,
  getUserById,
  updateUser,
  ...
  return (
    <>
      ...
      <PageTitle title={isEditView ? "Edit Donation Category" : "Add Donation Category"} />
      <Form
        className="AddUser"
        form={form}
        layout="vertical"
      ...
      >
        <Row className="fields-row" gutter={20} type="flex">
          <Col span={8} xs={24} sm={12} lg={12}>
            ...
            <Form.Item label="Parent Category" name="Category" rules={[{ required: true }]}>
            ...
            <Form.Item label="Fixed Amount" name="firstName" rules={[{ required: true }]}>
              ...
              <div className="text-center">
                <div className="bg-gray">
                  ...
                  <div className="upload-container">
                    <Upload showUploadList={false} beforeUpload={() => {}} onChange={() => {}}>
                      <Button>Image</Button>
                    </Upload>
                  </div>
                </div>
...
AddEditBaitussalamWebAndAppDonationCategoryManagementContainer.propTypes = {
...
export default AddEditBaitussalamWebAndAppDonationCategoryManagementContainer;
