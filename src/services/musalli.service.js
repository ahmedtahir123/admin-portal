...
const musalliService = {
  ...
  getAllParticipantsByMosque: query => get(`api/role-admin/v1/participant/mosque/${query}`),
  ...
  getMusalliPayment: query => get(`api/role-admin/v1/payment-request/session/1`),
